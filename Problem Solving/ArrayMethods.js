...
console.log("copyWithIn:",copyArr.copyWithin(1,3))
...
// 5,fill => will fill the value based on start and end, change original ARRAY,affects Original array so that commented

// i,fill(value),
//let fill1=arr1.fill(2)
//  console.log("fill",fill1) 
//  console.log("fill",arr1)//out=>[2, 2, 2, 2, 2, 2, 2, 2, 2, 2] 

//ii,fill(value, start),
// let fill2=arr1.fill(2,5)
//  console.log("fill",fill2) //out=>[2, 2, 2, 2, 2, 2, 2, 2, 2, 2]

//ii,fill(value, start, end)
// let fill3=arr1.fill(2,5,7)
// console.log("fill",fill3) //out=>[1, 4,  5, 6,  7, 2, 2, 10, 9, 10]
...
console.log("findIndexWithCondition :",findIndexWithCondition) //out=>2 3 is greater than 2 and it is in 2nd index , returns -1 when no value
//7b, findLastIndex() used to find index of last element which satisfies condition
let findLastIndexWithCondition=arr1.findIndex((ele)=>ele>2)
...
console.log(mapString.map((ele)=>ele.split(" "))) //OUT=>[ [ 'hello', 'I', 'am', 'Good' ] ]
console.log(mapString.flatMap((ele)=>ele.split(" "))) //OUT=>['hello', 'I', 'am', 'Good'];
...
let fromArray=["wewefwefwe","wwwwg"]
let newFromArray=Array.from(fromArray);
console.log(newFromArray) //OUT=>[ 'wewefwefwe', 'wwwwg' ]
//And can do map functions also
let newFromArray2=Array.from(fromArray,(x)=>x+"MAP-ADDED") //OUT=>[ 'wewefwefweMAP-ADDED', 'wwwwgMAP-ADDED' ]
console.log(newFromArray2)
...
console.log("Array.of : ",Array.of(10));//out=>[ 10 ]
console.log("Array : ",Array(10)) //out=> [ <10 empty items> ] create empty array with nth index
...
// console.log("Splice :",animalsSplice.slice(2));//out=>[ 'camel', 'duck', 'elephant' ];
...
console.log("Splice :",animalsSplice)//out=>[ 'ant', 'bison' ]
...
//22 array.with(index, value)=>replace a value in array with the indexn and value given as arguement
